...
struct OpenFoodFactsClient: FoodFactsService {
    ...
    private static let userAgent = "OpenFoodFactsExplorer/1.0 (iOS; github.com/pranavdivichenchu)"
    ...
    private static let fields = [
        ...
        "allergens_tags", "additives_tags", "labels_tags", "categories_tags",
        "ingredients_analysis_tags", "nutrient_levels", "nutriments",
    ].joined(separator: ",")
